...
public class TestGuru99PDEmail extends BaseClass {
	...
	@Test
	public void testPDFReportOne()throws Exception{
	...
	//Testcase failed so screen shot generate
	@Test
	public void testPDFReporTwo()throws Exception{
		driver = BaseClass.getDriver();
	...
	@Test
	public void testPDFReportThree()throws Exception{
		driver = BaseClass.getDriver();
	...
	public void tearDown(){
		sendPDFReportByGMail("thanhletraining01@gmail.com", "logigear123", "liennguyen2811@gmail.com", "PDF Report", "");
	}
